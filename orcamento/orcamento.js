document.addEventListener("DOMContentLoaded", function () {
  ...
  function carregarOrcamentos(usuarioId) {
    fetch(`https://localhost:7181/orcamento/${usuarioId}`, {
      method: "GET",
      headers: {
  ...
  form.addEventListener("submit", function (event) {
    ...
    fetch("https://localhost:7181/orcamento/cadastrar", {
      method: "POST",
      headers: {
  ...
  modalForm.addEventListener("submit", function (event) {
    ...
    fetch(`https://localhost:7181/orcamento/${orcamentoId}`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  function carregarOrcamentoParaEdicao(orcamentoId) {
    fetch(`https://localhost:7181/orcamento/obter-orcamento/${orcamentoId}`, {
      method: "GET",
      headers: {
        Authorization: `Bearer ${localStorage.getItem("token")}`,
      },
